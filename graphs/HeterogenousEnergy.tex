...
\begin{tikzpicture}
    ...
    \begin{axis}[
        ...
        symbolic x coords={CPU,GPU,FPGA,HP},
        xtick = data,
        nodes near coords,
        ...
        \addplot[style={blue,fill=blue!60}, every node near coord/.append style={rotate=0, anchor=west,inner xsep=20pt}]
            coordinates {(CPU, 17.30) (GPU, 16.30) (FPGA, 0.82) (HP, 15.00)}; % Histogram Equalisation + ResNet-50
        \addplot[style={darkcandyapplered,fill=darkcandyapplered}, every node near coord/.append style={rotate=0, anchor=west,inner xsep=20pt}]
            coordinates {(CPU, 7.80) (GPU, 4.70) (FPGA, 0.51) (HP, 5.00)}; % Gaussian Filter + MobilnetV2
        \addplot[style={forestgreen,fill=forestgreen}, every node near coord/.append style={rotate=0, anchor=west,inner xsep=20pt}]
            coordinates {(CPU, 18.33) (GPU, 11.09) (FPGA, 0.45) (HP, 12.00)}; % RGB2Gray + InceptionV3
    ...
    \begin{axis}[
        ...
        \addplot[style={blue,fill=blue!30},]
            coordinates {(CPU, 2.78) (GPU, 0.33) (FPGA, 0.29) (HP, 0.30)}; % Histogram Equalisation + ResNet-50
        \addplot[style={darkcandyapplered,fill=darkcandyapplered!30}]
            coordinates {(CPU, 0.98) (GPU, 0.26) (FPGA, 0.19) (HP, 0.20)}; % Gaussian Filter + MobilnetV2
        \addplot[style={forestgreen,fill=forestgreen!30}, every node near coord/.append style={rotate=0, anchor=west,inner xsep=0pt}]
            coordinates {(CPU, 3.60) (GPU, 0.44) (FPGA, 0.37) (HP, 0.40)}; % RGB2Gray + InceptionV3
    \end{axis}
\end{tikzpicture}