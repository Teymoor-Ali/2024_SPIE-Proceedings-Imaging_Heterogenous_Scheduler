...
\begin{figure}[H]
    ...
    \caption{Heterogeneous Platform Environment}
...
CPU & \begin{tabular}[c]{@{}c@{}}AMD 5900x \\ (4.8 GHz)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Python / OpenCV /\\Pytorch 2.4\end{tabular} & RAPL \\ 
\cmidrule{1-3}\cline{4-4}
GPU & \begin{tabular}[c]{@{}c@{}}Nvidia A2000 \\ (1200 MHz)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Python / OpenCV /\\Pytorch 2.4\end{tabular} & Nvidia SMI\cite{Nvidiasmi} \\ 
\cmidrule{1-3}\cline{4-4}
FPGA & \begin{tabular}[c]{@{}c@{}}U50 \\ (300 MHz)\end{tabular} & \begin{tabular}[c]{@{}c@{}}HLS (C++) / \\Vitis Vision Library\cite{vitis}\end{tabular} & Xbutil\cite{XButil} \\
\bottomrule
\end{tabular}
}
\end{table}
